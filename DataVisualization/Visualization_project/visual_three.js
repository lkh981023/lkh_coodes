{
    ...
    var svg = d3.select("#visual_three")
        .append("svg")
    ...
    //Read the data
    d3.csv('work_n_satisfation.csv', function (data) {
        ...
        var Tooltip = d3.select("#visual_three")
            .append("div")
            .style("opacity", 0)
            .attr("class", "tooltip")
        ...
        svg.append('g')
            ...
            .attr("r", 10)
            .style("fill", function (d) { return myColor(d.Contintent); })
